...
import { VoucherDetail } from "../../../shared";
...
export class VoucherDetailsListComponent implements OnInit {
  ...
  @Output()
  detailSelected: EventEmitter<VoucherDetail> = new EventEmitter();
  @Output()
  detailDeleted: EventEmitter<VoucherDetail> = new EventEmitter();
  @Output()
  detailAdd: EventEmitter<VoucherDetail> = new EventEmitter();
